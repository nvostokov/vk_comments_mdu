...
$('#ghest29').on('click', loadComments); //запуск по кнопке
/* $('#load').ready(loadComments); */

let urlDomain2 = "ghest29";
            ...
            for (let i = 0; i < comments.length; i++) {
                ...
                html += '<li>' + 
                            ...
                            + '<div class="comments__link">'
                                + '<a target="_blank" href="https://vk.com/' +/*  urlDomain2 + '?w=wall' */ 'wall'+ f.owner_id + '_' + f.post_id + '">' 
                                + 'ссылка на пост' + '</a>' 
                            +'</div>'
                    + '</li>';
            }
