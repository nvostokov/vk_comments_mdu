...
$('#load_ghest29').on('click', loadComments); //запуск по кнопке
/* $('#load').ready(loadComments); */
	...
	let urlDomainGhest29 = "ghest29";

	function loadComments() {
		sendRequest('wall.search', {/* owner_id: -10564356, */ domain: urlDomainGhest29, count: 50, query: "МДУ", query: "Мезенское", query: "дороги", query: "мезенцы", query: "дорожники", query: "тротуар", v: 5.131}, function (data) {
